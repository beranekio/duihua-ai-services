...
- `BACKGROUND_WORKER_IMAGE_TAG` (default: `kind`)
- `BACKGROUND_WORKER_SRC` (default: `../duihua-background-worker`; falls back to published GHCR image when absent)
