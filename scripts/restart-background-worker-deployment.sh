...
BACKGROUND_WORKER_DEPLOYMENT="${RELEASE_NAME}-duihua-ai-services-background-worker"
...
kubectl rollout status deployment/"${BACKGROUND_WORKER_DEPLOYMENT}" -n "${NAMESPACE}" --timeout="${TIMEOUT}"